    ...
    <>
          ...
          {solutions.map((solution, i) => (
            ...
            >
              <div className={i % 2 === 1 ? 'lg:order-2' : ''}>
                ...
                <h2 className="mt-2 text-3xl font-bold text-navy">{solution.headline}</h2>
                ...
                <div className="mt-8">
                  ...
                  <ul className="space-y-3">
                    {solution.problems.map((problem) => (
                      <li key={problem} className="flex items-start gap-3 text-navy/80">
                ...
                <div className="mt-8">
                  ...
                  <ul className="space-y-3">
                    {solution.solutions.map((sol) => (
                      <li key={sol} className="flex items-start gap-3 text-navy/80">
              ...
              <div className={`${i % 2 === 1 ? 'lg:order-1' : ''}`}>
                <div className="card-shadow rounded-2xl border border-border bg-white p-8">
                  <div className="mb-6 h-2 w-24 rounded bg-primary" />
                  <div className="space-y-4">
                    {solution.solutions.map((sol, j) => (
                      <div key={sol} className="flex items-center gap-4 rounded-xl bg-surface p-4">
                        ...
                        <p className="text-sm font-medium text-navy">{sol}</p>
                      </div>
                    ))}
                  </div>
                </div>
      ...
      <section className="section-padding bg-navy">
        <div className="container-wide text-center">
          <h2 className="text-3xl font-bold text-white">Find the Right Solution</h2>
          ...
          <div className="mt-8 flex justify-center gap-4">
            ...
            <Button to="/contact" variant="outline" className="!border-white/30 !text-white hover:!bg-white hover:!text-navy">
              Talk to Us
            </Button>
          </div>
        </div>
